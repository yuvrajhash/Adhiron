  ...
  <div className="container mx-auto px-6 relative z-10">
    ...
    >
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-white to-blue-50 -z-10"></div>
        <div className="absolute top-20 left-10 w-32 h-32 rounded-full bg-blue-100 opacity-40 -z-10"></div>
        <div className="absolute bottom-20 right-10 w-48 h-48 rounded-full bg-indigo-100 opacity-50 -z-10"></div>
        <div className="absolute top-1/3 right-1/4 w-16 h-16 rounded-full bg-purple-100 opacity-30 -z-10"></div>
            ...
            {[
              {
                ...
                image: "/images/kateryna-hliznitsova-hEX5R8u7gCI-unsplash.jpg",
                testimonial: "The quality of Adhiron's services is exceptional. As a healthcare professional, I confidently recommend them to my patients."
              },
              {
                name: "Michael Rodriguez",
                role: "Patient",
                image: "/images/crystal-kwok-28U1dQ9FUSg-unsplash.jpg",
                testimonial: "The healthcare services from Adhiron have made a significant difference in my health journey. Their customer service is also outstanding."
              },
              {
                name: "Emily Chen",
                role: "Regular Customer",
                image: "/images/glsun-mall-WNX6uk-1LV4-unsplash.jpg",
                testimonial: "I've been using Adhiron's services for years. Their commitment to quality and personalized care keeps me coming back."
              }
              ...
              <motion.div
                ...
                className="bg-white p-8 rounded-2xl shadow-lg hover-lift relative overflow-hidden"
              >
                {/* Decorative quote mark */}
                <div className="absolute top-6 right-6 text-6xl text-blue-100 font-serif leading-none z-0">"</div>
                
                <div className="relative z-10">
                  <p className="text-gray-700 italic text-lg mb-6 relative z-10">"{testimonial.testimonial}"</p>
                  
                  <div className="flex items-center">
                    <div className="w-16 h-16 rounded-full overflow-hidden mr-4 border-2 border-blue-100 shadow-md">
                      <Image
                ...
                <motion.div 
                  ...
                  className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-r-full"
                />
              </motion.div>
            ))}
          </motion.div>
