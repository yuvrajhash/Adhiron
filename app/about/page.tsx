...
const testimonials = [
  {
    ...
    quote:
      "Aurora Farmabio consistently delivers high-quality, innovative ingredients that meet the strictest regulatory standards.",
...
<p>Our reach today spans continents, yet our values remain grounded. We serve both the human wellness and animal health sectors with equal dedication, developing natural solutions tailored to diverse lifestyles and markets. What sets us apart is not only our expertise, but also our unwavering commitment to research, sustainability, and customer-centricity. Every step we take is guided by integrity and a deep respect for nature.</p>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            custom={6}
            className="bg-white/90 backdrop-blur-lg border border-indigo-100 rounded-3xl shadow-2xl p-12"
          >
            <h2 className="text-3xl font-bold text-indigo-800 mb-8 flex items-center gap-3">
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {testimonials.map(({ name, title, quote, imageUrl }, i) => (
                <motion.div
                  ...
                  className="bg-indigo-50 rounded-2xl p-6 flex gap-6 items-center"
                >
                  <Image
                    src={imageUrl}
                    alt={name}
          ...
          >
            ...
            <p className="text-lg max-w-2xl mx-auto mb-8">
              Contact us today to learn more about our product portfolio, custom formulations, and how we can support your pharmaceutical manufacturing needs.
            </p>
            <a
